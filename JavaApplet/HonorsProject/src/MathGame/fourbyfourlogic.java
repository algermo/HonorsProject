/*****************************************************************
Starting logic for the game (4x4 board)
...
public class fourbyfourlogic {
	...
	public fourbyfourlogic (int c, int r) {
		rows = r; 
		columns = c; 
		board = new int[c][r];
	}

	public fourbyfourlogic (int[][] brd){
		board = brd; 
		columns = brd.length; 
		rows = brd[0].length; 
	}

	public fourbyfourlogic (){
